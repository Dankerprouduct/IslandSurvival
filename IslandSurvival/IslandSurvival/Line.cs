...
namespace IslandSurvival
{
    public class Line
    {
        ...
        public Line(Vector2 p1, Vector2 p2, int thickness, Color color, GraphicsDevice gDevice)
        {
            this.pixel = new Texture2D(gDevice, 1, 1, false, SurfaceFormat.Color);


            Int32[] pixels = { 0xFFFFFF };
            pixel.SetData<Int32>(pixels, 0, pixel.Width * pixel.Height);
